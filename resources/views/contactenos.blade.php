                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="fas fa-map-marker-alt mr-2 text-blue-500"></i><strong>Dirección:</strong> Carrera 9 #9-78 Barrio base Area</li>
                                </ul>
                                ...
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3">Enviar mensaje</button> <a href="{{ route('dashboard') }}" class="btn btn-secondary mt-4">Volver al Dashboard</a>
                                </form>
                            </div>
                            <div class="col-md-6">
